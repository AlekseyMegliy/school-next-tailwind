...
export default function Form({ handleOffClick }: SomeComponentProps) {
  return (
    <div className="fixed left-1/2 z-50 my-2 w-4/5 -translate-x-1/2 -translate-y-1/2 transform overflow-hidden bg-white px-2 text-center text-small opacity-100 transition-all duration-300 sm:-translate-y-3/4 md:my-28 md:w-3/5 md:-translate-y-1/2 md:px-16 md:text-main lg:mx-0  lg:w-2/5 lg:text-ml">
      ...
      <form className="flex flex-col gap-4 rounded-lg bg-white text-main md:gap-7 ">
        <input
      ...
      <div className="shadow-golden absolute -bottom-36 -right-36 -z-10 h-20 w-32 rotate-45 transform bg-gold md:-bottom-28 md:-right-28" />
    </div>
  );
}
